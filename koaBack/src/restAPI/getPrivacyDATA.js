...
const DATA = {
    ...
    isGraduation:true,
     ...
     desc:`
         개구장이 어린아이처럼 세상을 바라보는 개발자가 되고 싶습니다. </p>
         선입견이나 성급한 판단 , 고정된 시선에서 벗어나 그 자체를 그대로 바라보며 </p>
         "우와 이거 정말 멋져요, 이게 어떻게 움직이는거죠? 이건 뭐죠?" </p>
         항상 만족할 줄 모르는 호기심을 가지고 , 끊임없이 상상하며  본질적인 개발의 즐거움을 잊지 않는 개발자 되고 싶습니다.</p>
     `
}
