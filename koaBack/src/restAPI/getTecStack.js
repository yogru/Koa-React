...
const tecStack=[
    ...
    desc:`
        ...
        라는 인터넷글을 보고 울며 겨자 먹기식으로 짰던 경험이 있습니다. 

        많은 시간 매달려가며 겨우 완성 시켰을때, 성취감은 아직도 잊혀지지 않습니다.

    ` },
    {name:"Spring", src:"/image/spring.png", desc:`
      GOF의 디자인패턴보다 훨씬 더 깔끔한 디자인으로 처음에 충격 받았습니다.

      의존성 주입 , 관점지향 , PSA과 개념으로 정말 비즈니스 로직에 
      집중 할 수 있도록 하는 스프링에 감명받았습니다. 
  
    `},
    {name:"SQL", src:"/image/sql.png", desc:`
    군대에 있을 때 html-js로 당직근무표, 알람, 오목 만들었는데, 
     더 이상 성장하는 느낌이 들지 않았습니다.  
