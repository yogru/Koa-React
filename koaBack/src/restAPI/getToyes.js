...
const toyes=[
    {
     ...
     desc:
      `<p> 퍼펫티어는 브라우저를 조작하여 페이지를 조작할 수 있기 때문에
       웹에서의 가능성이 무궁무진하여 사용해보고 싶었습니다. </p>
      <p>  예제는 쿠팡 검색어를 입력하면 로켓과 새벽배송만 물품을 가져오도록 만들었습니다.</p>
      <p> 현재 목표는 설정하는 페이지를 만들어서 좀 더 범용적인 프로젝트로 만들고 싶습니다  </p>
      `,
    ...
    },
    {
       ...
       desc:`
         <p>프론트 희망한다면, "자신의 이력서를 웹으로 
         서비스하는것이 기본이다" 라고 책에서 봤을때 뜨끔했습니다</p>
         <p>그래서 지금 부랴부랴 기본을 챙기는 중입니다.</p>
       `,
    ...
    },
    {
     ...
     desc:`
      <p>  현재 sql 모델링툴 무료로 좋은것이 많기 때문에 
          굳이 더 개발할 필요성을 못느껴서 방치중 입니다.  </p>
     `,
